...
IEnumerator SpawnRoutine()
  	{
    	...
    	while (!_gameState.GameOver)
            {
            // get new position for corona
            _spawnPosition = GetSpawnPosition();

            // create a new corona from prefab
  	...
  	{
    	// get a random position from the bounds of the CoronaSpawner's Box Collider
    	// use this to position our new spawned corona
